<form method = "post" action = "cible_connection.php" id ="formulaire" class="form-horizontal col-md-offset-3 col-lg-6">
...
<form method = "post" action = "cible_inscription.php" id ="formulaire" class="form-horizontal col-md-offset-3 col-lg-6">
  <div class="form-group">
